...
> Draft spoken lines. Structure lives in `[outline.md](./outline.md)`; register and delivery rules in `[tone.md](./tone.md)`. No stage directions, no time stamps. Easy to read, not buried in prose. 7-8 minutes long. Side details below are currently just seed ideas, starting suggestions, and should not be taken as fully composed unless otherwise noted.
...
Drastic reduction in the cost per mile. Massive job loss in the ridehail and delivery economy. Less accidents, fewer injuries, and less loss of life. And they're right — that's real, and it matters.
