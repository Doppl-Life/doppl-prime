...
## <a id="32"></a>32. A cross-subsystem ACCEPTANCE OUTPUT is a first-class persisted model (modeled on its authoritative sibling) — and a closed-set breakdown is keyed by `z.record(ClosedEnum, …)`, not duplicated literals
