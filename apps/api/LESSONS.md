...
## <a id="20"></a>20. A cross-subsystem ACCEPTANCE OUTPUT is a first-class persisted model (modeled on its authoritative sibling) — and a closed-set breakdown is keyed by `z.record(ClosedEnum, …)`, not duplicated literals
