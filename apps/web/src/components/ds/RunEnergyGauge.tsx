/**
 * RunEnergyGauge — the run-wide energy budget as a draining charge: the visible "this is finite by
 * construction" signal (RunCaps.energyBudget). Segmented charge meter + mono spent/budget; the glow
 * shrinks as energy drains. Thresholds nominal / warning (<30% left) / critical / exhausted.
    ...
    remaining <= 0
      ...
      : remaining < 0.1
        ...
        : remaining < 0.3
          ? 'var(--energy-mid)'
          : 'var(--energy-full)';
  const litCount = Math.round(remaining * SEGMENTS);
  return (
