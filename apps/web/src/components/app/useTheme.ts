 ...
 * restores it on boot (dark default when unset/invalid). The DS theme transition is instant — the
...
/** Read the persisted theme; an unset/invalid value falls back to the dark default. */
