...
- the **phase set** this track owns (a subset of `P0 / P1 / P2 / P3 / P4 / P5 / P6 / P7 / PD`),
- its **code area(s)**,
- its **upstream-track dependencies** (tracks that must merge before this one integrates),
- its **worktree path + branch** (default convention: `../Capstone-<track>` on branch `track/<track>`).
...
1. **`IMPLEMENTATION_PLAN.md`** — focused sections:
   ...
   - **The active phase within this track's phase set** (P0 / P1 / P2 / P3 / P4 / P5 / P6 / P7 / PD prefix) — task IDs + one-line topics. (Single-track plan → the active phase globally.)
...
```bash
git worktree add ../Capstone-<track> track/<track>   # or the base branch the Track map specifies
```
...
```
You are <track>-<area>-orchestrator on the Doppl agent team.
...
```
You are <track>-<area>-implementer on the Doppl agent team.
