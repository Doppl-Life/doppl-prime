...
1. Read the lookup table in `apps/api/CLAUDE.md` (top section, near "Lookup table — where to find canonical info").
...
Recommendation: add a row to the apps/api/CLAUDE.md lookup table:
| <topic> | <file> | §<section> |
```
